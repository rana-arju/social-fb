...
const OldCover = ({ photos, setCoverPicture, setShow }) => {
  const { user } = useSelector((state) => ({ ...state }));
  const oldCover = useRef(null);
  useClickOutside(oldCover, () => setShow(false))
  return (
    <div className="blur">
      <div className="postBox selectCoverBox" ref={oldCover}>
